...
namespace ToolsQASeleniumTutorial {
    class DriverCommands
    {
        public static void Main (string[] args) {
             //Launch the ToolsQA Website
             FirefoxDriverService service = FirefoxDriverService.CreateDefaultService ("/Users/Owner/Projects/ToolsQASeleniumTutorial/bin/Debug/netcoreapp2.0/");
